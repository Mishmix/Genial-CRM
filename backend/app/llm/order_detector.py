...
- ЗАКАЗ (is_confirmed: true): есть чёткие сигналы подтверждения:
  ...
  * Клиент явно подтвердил ("да, делаем", "скинул оплату", "приступай", "жду")
  * Обсуждение деталей работы (ссылки на видео, референсы, ТЗ) ПОСЛЕ согласования
  * Клиент — постоянный, и просто пишет "нужна ещё одна обложка" (подразумевает старые условия)

НЕ ЗАКАЗ (has_order: false):
- Клиент просит что-то НЕ связанное с дизайном
- Просто поздоровался
